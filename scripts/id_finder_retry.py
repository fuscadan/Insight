"""
Created on Mon September  23 2019

@author: danie

    This program retries the game ID scraping algorithm for urls that couldn't
    be connected to when the main id_finder program was run.
    
    The ID numbers are appended to a file: 
...
if __name__ == '__main__':
    ...
    with open(RETRY_PATH, 'r') as retry_file:
        retry_urls = retry_file.readlines()
